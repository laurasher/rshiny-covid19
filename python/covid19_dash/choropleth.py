...
latLong_confirmed = total.loc[total['status'] =='confirmed']['Lat'], total.loc[total['status'] =='confirmed']['Long']
latLong_recovered = total.loc[total['status'] =='recovered']['Lat'], total.loc[total['status'] =='recovered']['Long']
latLong_deaths = total.loc[total['status'] =='deaths']['Lat'], total.loc[total['status'] =='deaths']['Long']
...
US_latLong_confirmed = US_total.loc[US_total['status'] =='confirmed']['Lat'], US_total.loc[US_total['status'] =='confirmed']['Long']
US_latLong_recovered = US_total.loc[US_total['status'] =='recovered']['Lat'], US_total.loc[US_total['status'] =='recovered']['Long']
US_latLong_deaths = US_total.loc[US_total['status'] =='deaths']['Lat'], US_total.loc[US_total['status'] =='deaths']['Long']

print(f'---------------US_county_confirmed, {US_county_confirmed}')

US_map_source_confirmed = ColumnDataSource(data=dict(x=latLong_confirmed[0],
                                                     y=latLong_confirmed[1],
                                                     size=10*np.log10(total.loc[total['status'] =='confirmed'][latestDateCol])))
US_map_source_recovered = ColumnDataSource(data=dict(x=latLong_recovered[0],
                                                     y=latLong_recovered[1],
                                                     size=10*np.log10(total.loc[total['status'] =='recovered'][latestDateCol])))
